...
public class UpdateAccountController {
    ...
    @RequestMapping(value = "/accounts/users/{accountId}", method = RequestMethod.PUT)
    public Account updateUserAccount(@PathVariable String accountId, @RequestBody(required=false) UserAccount account)
                                     throws Exception {
    ...
    @RequestMapping(value = "/accounts/doctors/{category}/{accountId}", method = RequestMethod.PUT)
    public Account updateDoctorAccount(@PathVariable String accountId, @PathVariable String category, @RequestBody(required=false) DoctorAccount account)
                                       throws Exception {
        // repository null, server error
        if (repository == null) {
            throw new ServerSideProblemException("repository null");
    ...
    @RequestMapping(value = "/accounts/admins/{accountId}", method = RequestMethod.PUT)
    public Account updateAdminAccount(@PathVariable String accountId, @RequestBody(required=false) AdminAccount account)
                                      throws Exception {
        // repository null, server error
        if (repository == null) {
            throw new ServerSideProblemException("repository null");
