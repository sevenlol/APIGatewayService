...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .authorizeRequests().antMatchers(HttpMethod.GET, "/favorite/**").permitAll()
        .and()
            .authorizeRequests().antMatchers(HttpMethod.POST, "/favorite/**").permitAll()
        .and()
            .authorizeRequests().antMatchers(HttpMethod.PUT, "/favorite/**").permitAll()
        .and()
            .authorizeRequests().antMatchers(HttpMethod.DELETE, "/favorite/**").permitAll()
	    .and()
